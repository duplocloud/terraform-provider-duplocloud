...
- `k8s_worker_os` (String) OS type for k8s worker. Valid values: `Linux`, `Windows`. Defaults to `Linux`.
...
<a id="nestedblock--init_container_docker_image"></a>
### Nested Schema for `init_container_docker_image`

Required:

- `image` (String) Init container docker image.
