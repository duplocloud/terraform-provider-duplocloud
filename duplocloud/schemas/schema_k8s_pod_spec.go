...
func podSpecFields(isUpdatable, isComputed bool) map[string]*schema.Schema {
	s := map[string]*schema.Schema{
		...
		"active_deadline_seconds": {
			...
			ValidateFunc: duplocloud.validatePositiveInteger,
		...
		"dns_policy": {
			...
			Computed:    isComputed,
			ForceNew:    !isUpdatable,
			Default:     duplocloud.conditionalDefault(!isComputed, string(api.DNSClusterFirst)),
			...
			Elem: &schema.Resource{
				Schema: map[string]*schema.Schema{
					...
					"searches": {
						...
						Elem: &schema.Schema{
							Type:         schema.TypeString,
							ValidateFunc: duplocloud.validateName,
							ForceNew:     !isUpdatable,
						},
					},
				},
		...
		"host_ipc": {
			...
			Computed:    isComputed,
			ForceNew:    !isUpdatable,
			Default:     duplocloud.conditionalDefault(!isComputed, false),
		...
		"restart_policy": {
			...
			Computed:    isComputed,
			ForceNew:    !isUpdatable,
			Default:     duplocloud.conditionalDefault(!isComputed, string(api.RestartPolicyAlways)),
			...
			Elem: &schema.Resource{
				Schema: map[string]*schema.Schema{
					"fs_group": {
						...
						Optional:     true,
						ValidateFunc: duplocloud.validateTypeStringNullableInt,
						ForceNew:     !isUpdatable,
					},
					"run_as_group": {
						Type:         schema.TypeString,
		...
		"termination_grace_period_seconds": {
			...
			Computed:     isComputed,
			ForceNew:     !isUpdatable,
			Default:      duplocloud.conditionalDefault(!isComputed, 30),
			ValidateFunc: duplocloud.validateTerminationGracePeriodSeconds,
					...
					Elem: &schema.Resource{
						Schema: map[string]*schema.Schema{
							...
							"mode": {
								...
								ValidateFunc: duplocloud.validateModeBits,
							},
							"path": {
								Type:         schema.TypeString,
								Optional:     true,
								ValidateFunc: duplocloud.validateAttributeValueDoesNotContain(".."),
								...
								Elem: &schema.Resource{
									Schema: map[string]*schema.Schema{
										...
										"divisor": {
											...
											Optional:         true,
											Default:          "1",
											ValidateFunc:     duplocloud.validateResourceQuantity,
											DiffSuppressFunc: duplocloud.suppressEquivalentResourceQuantity,
										},
										"resource": {
											Type:        schema.TypeString,
											Required:    true,
		...
		Elem: &schema.Resource{
			Schema: map[string]*schema.Schema{
				"medium": {
					...
					Default:      "",
					ForceNew:     !isUpdatable,
					ValidateFunc: duplocloud.validateAttributeValueIsIn([]string{"", "Memory"}),
				},
				"size_limit": {
					Type:             schema.TypeString,
								...
								Elem: &schema.Resource{
									Schema: map[string]*schema.Schema{
										"annotations": {
											...
											Optional:     true,
											Elem:         &schema.Schema{Type: schema.TypeString},
											ValidateFunc: duplocloud.validateAnnotations,
										},
										"labels": {
											Type:         schema.TypeMap,
											...
											Optional:     true,
											Elem:         &schema.Schema{Type: schema.TypeString},
											ValidateFunc: duplocloud.validateLabels,
										},
									},
								},
							},
								...
								Elem: &schema.Resource{
									Schema: map[string]*schema.Schema{
										...
										"expiration_seconds": {
											...
											ValidateFunc: duplocloud.validateIntGreaterThan(600),
										},
										"path": {
											Type:        schema.TypeString,
