...
- `storage_size` (Number, Deprecated) The storage volume size, in GB, for the ElasticSearch instance. storage_size has been deprecated, use ebs_options.volume_size
...
- `instance_type` (String) Supported instance types for elasticsearch domain https://docs.aws.amazon.com/opensearch-service/latest/developerguide/supported-instance-types.html Defaults to `t2.small.search`.
