...
- `zone` (Number, Deprecated) The availability zone to launch the host in, expressed as a number and starting at 0. zone has been deprecated instead use zones
- `zones` (List of Number) The multi availability zone to launch the asg in, expressed as a number and starting at 0 - Zone A 1 - Zone B. For Automatic do not specify zones or zone field
