...
page_title: "duplocloud_aws_cloudfront_distribution_v2 Resource - terraform-provider-duplocloud"
subcategory: ""
description: |-
  duplocloud_aws_cloudfront_distribution_v2 manages an aws cloudfront distribution in Duplo.
---

# duplocloud_aws_cloudfront_distribution_v2 (Resource)
...
- `name` (String) Name of the cloudfront distribution
...
- `use_origin_access_control` (Boolean) Duplo will create an origin access control (OAC) and restrict the S3 origin access. On false it will be public</br>For migration from OAI to OAC can be done from duplo cloud portal. Defaults to `true`.
