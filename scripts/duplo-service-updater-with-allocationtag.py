...
def deploy_new_service(g_serviceName, aInImage, aInHeaders, aInHostName):
    data = {
                "Name": g_serviceName,
                "Image": aInImage,
                "AllocationTags": aInHostName
            }
    logger.info(data)
...
if __name__ == '__main__':
    ...
    deploy_new_service(sys.argv[1], sys.argv[2], jheaders, sys.argv[3])
