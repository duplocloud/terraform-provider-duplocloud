...
- `health_check_port` (Number) The port the load balancer uses when performing health checks on targets. If not specified, it will be treated as the traffic port.
